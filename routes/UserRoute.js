...
const { registerUser, loginUser, forgotPassword, uploadImage, updateProfileDetails, deleteUser, getUserByEmail, getUserDashboard } = require("./../controllers/UserController")
